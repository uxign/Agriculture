...
class Cursor {
    ...
    render() {
        ...
        this.DOM.circle.style.transform = `translateX(${this.lastMousePos.x
...
jQuery(".slider-active, .swiper-wrapper").hover(
    function () {
        jQuery('.cursor .c-cursor__inner').addClass('drag');
    },
    function () {
        jQuery('.cursor .c-cursor__inner').removeClass('drag');
    }
);
